...
class DrawWalkingPathLinesTool extends Autodesk.Viewing.ToolInterface {
  ...
  extractLastPathPoints() {
    ...
    const scene =
      viewer.impl.overlayScenes[DrawWalkingPathLinesOverlayName].scene;
...
class WalkingPathToolExtension extends Autodesk.Viewing.Extension {
  ...
  onToolbarCreated(toolbar) {
    ...
    drawWalkingPathButton.addClass("fas");
    // drawWalkingPathButton.addClass('fa-pencil');
    drawWalkingPathButton.addClass("fa-pen");
    drawWalkingPathButton.addClass("fa-2x");
    ...
    walkNavButton.addClass("fas");
    walkNavButton.addClass("fa-shoe-prints");
    walkNavButton.addClass("fa-2x");
...
export default WalkingPathToolExtension;
