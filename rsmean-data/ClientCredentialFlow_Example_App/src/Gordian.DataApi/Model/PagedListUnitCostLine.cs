...
{
    /// <summary>
    /// PagedListUnitCostLine
    /// </summary>
    [DataContract]
    public partial class PagedListUnitCostLine :  IEquatable<PagedListUnitCostLine>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedListUnitCostLine" /> class.
        /// </summary>
        /// <param name="offset">The offset..</param>
        /// <param name="limit">The limit..</param>
        /// <param name="recordCount">The record count..</param>
        /// <param name="items">The items..</param>
        public PagedListUnitCostLine(int? offset = default(int?), int? limit = default(int?), long? recordCount = default(long?), List<UnitCostLine> items = default(List<UnitCostLine>))
        {
            this.Offset = offset;
            this.Limit = limit;
        ...
        public List<UnitCostLine> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedListUnitCostLine {\n");
        ...
        {
            return this.Equals(input as PagedListUnitCostLine);
        }

        /// <summary>
        /// Returns true if PagedListUnitCostLine instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedListUnitCostLine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedListUnitCostLine input)
        {
            if (input == null)
                return false;
