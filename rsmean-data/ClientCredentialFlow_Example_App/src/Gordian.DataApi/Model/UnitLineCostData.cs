...
{
    /// <summary>
    /// Unit Cost Line CostData.
    /// </summary>
    [DataContract]
    public partial class UnitLineCostData :  IEquatable<UnitLineCostData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitLineCostData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UnitLineCostData {\n");
        ...
        {
            return this.Equals(input as UnitLineCostData);
        }

        /// <summary>
        /// Returns true if UnitLineCostData instances are equal
        /// </summary>
        /// <param name="input">Instance of UnitLineCostData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnitLineCostData input)
        {
            if (input == null)
                return false;
