...
{
    /// <summary>
    /// Localized Assembly Line CostData.
    /// </summary>
    [DataContract]
    public partial class LocalAssemblyLineCostData :  IEquatable<LocalAssemblyLineCostData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalAssemblyLineCostData" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocalAssemblyLineCostData {\n");
        ...
        {
            return this.Equals(input as LocalAssemblyLineCostData);
        }

        /// <summary>
        /// Returns true if LocalAssemblyLineCostData instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalAssemblyLineCostData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalAssemblyLineCostData input)
        {
            if (input == null)
                return false;
