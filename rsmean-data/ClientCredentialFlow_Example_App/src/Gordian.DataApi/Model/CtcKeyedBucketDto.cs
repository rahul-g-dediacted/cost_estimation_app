...
namespace Gordian.DataApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class CtcKeyedBucketDto :  IEquatable<CtcKeyedBucketDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CtcKeyedBucketDto" /> class.
        /// </summary>
        /// <param name="docCount">docCount.</param>
        public CtcKeyedBucketDto(int? docCount = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CtcKeyedBucketDto {\n");
        ...
        {
            return this.Equals(input as CtcKeyedBucketDto);
        }

        /// <summary>
        /// Returns true if CtcKeyedBucketDto instances are equal
        /// </summary>
        /// <param name="input">Instance of CtcKeyedBucketDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CtcKeyedBucketDto input)
        {
            if (input == null)
                return false;
