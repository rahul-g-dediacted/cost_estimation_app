...
{
    /// <summary>
    /// CommercialBuildingWithExtendedCost
    /// </summary>
    [DataContract]
    public partial class CommercialBuildingWithExtendedCost :  IEquatable<CommercialBuildingWithExtendedCost>, IValidatableObject
    {
        /// <summary>
        /// Defines LaborType
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CommercialBuildingWithExtendedCost" /> class.
        /// </summary>
        ...
        public CommercialBuildingWithExtendedCost(string id = default(string), ReferenceRelease release = default(ReferenceRelease), ReferenceLocation location = default(ReferenceLocation), LaborTypeEnum? laborType = default(LaborTypeEnum?), string code = default(string), string description = default(string), ModelTypeEnum? modelType = default(ModelTypeEnum?), string modelActivityType = default(string), Wall wall = default(Wall), Renovation renovation = default(Renovation), bool? doesModelOfferBasement = default(bool?), BuildingParameters buildingParameters = default(BuildingParameters), BuildingFees feesPercent = default(BuildingFees), List<BuildingAssemblyDivisionWithExtendedCost> assemblyDivisionsLevelOne = default(List<BuildingAssemblyDivisionWithExtendedCost>), List<BuildingAssemblyDivisionWithExtendedCost> assemblyDivisionsLevelThree = default(List<BuildingAssemblyDivisionWithExtendedCost>), List<TradeUsage> buildingTradeUsages = default(List<TradeUsage>), BuildingExtendedCost buildingCost = default(BuildingExtendedCost), BuildingRequestParametersConstructConnect requestParameters = default(BuildingRequestParametersConstructConnect), List<string> warningMessages = default(List<string>))
        {
            this.Id = id;
        ...
        public List<BuildingAssemblyDivisionWithExtendedCost> AssemblyDivisionsLevelOne { get; set; }

        /// <summary>
        /// Gets or Sets AssemblyDivisionsLevelThree
        /// </summary>
        [DataMember(Name="assemblyDivisionsLevelThree", EmitDefaultValue=false)]
        public List<BuildingAssemblyDivisionWithExtendedCost> AssemblyDivisionsLevelThree { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommercialBuildingWithExtendedCost {\n");
        ...
        {
            return this.Equals(input as CommercialBuildingWithExtendedCost);
        }

        /// <summary>
        /// Returns true if CommercialBuildingWithExtendedCost instances are equal
        /// </summary>
        /// <param name="input">Instance of CommercialBuildingWithExtendedCost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommercialBuildingWithExtendedCost input)
        {
            if (input == null)
                return false;
