...
namespace Gordian.DataApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModifierCostData :  IEquatable<ModifierCostData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModifierCostData" /> class.
        /// </summary>
        ...
        public ModifierCostData(double? materialCost = default(double?), double? laborCost = default(double?), double? equipmentCost = default(double?), double? totalCost = default(double?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ModifierCostData {\n");
        ...
        {
            return this.Equals(input as ModifierCostData);
        }

        /// <summary>
        /// Returns true if ModifierCostData instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifierCostData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifierCostData input)
        {
            if (input == null)
                return false;
