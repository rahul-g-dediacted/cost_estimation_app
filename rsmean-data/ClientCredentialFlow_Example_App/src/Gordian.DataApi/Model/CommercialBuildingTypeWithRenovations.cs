...
{
    /// <summary>
    /// CommercialBuildingTypeWithRenovations
    /// </summary>
    [DataContract]
    public partial class CommercialBuildingTypeWithRenovations :  IEquatable<CommercialBuildingTypeWithRenovations>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CommercialBuildingTypeWithRenovations" /> class.
        /// </summary>
        /// <param name="id">id.</param>
        /// <param name="releaseYear">releaseYear.</param>
        /// <param name="code">code.</param>
        /// <param name="modelTypes">modelTypes.</param>
        /// <param name="description">description.</param>
        /// <param name="walls">walls.</param>
        /// <param name="renovations">renovations.</param>
        ...
        public CommercialBuildingTypeWithRenovations(string id = default(string), string releaseYear = default(string), string code = default(string), List<string> modelTypes = default(List<string>), string description = default(string), List<Wall> walls = default(List<Wall>), List<Renovation> renovations = default(List<Renovation>), bool? doesModelOfferBasement = default(bool?), List<BuildingAreaPerimeter> areaPerimeterGuidelines = default(List<BuildingAreaPerimeter>), BuildingParameters buildingParameters = default(BuildingParameters), BuildingFees feesPercent = default(BuildingFees))
        {
            this.Id = id;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CommercialBuildingTypeWithRenovations {\n");
            ...
            sb.Append("  Renovations: ").Append(Renovations).Append("\n");
        ...
        {
            return this.Equals(input as CommercialBuildingTypeWithRenovations);
        }

        /// <summary>
        /// Returns true if CommercialBuildingTypeWithRenovations instances are equal
        /// </summary>
        /// <param name="input">Instance of CommercialBuildingTypeWithRenovations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CommercialBuildingTypeWithRenovations input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.Renovations == input.Renovations ||
                    this.Renovations != null &&
                    this.Renovations.SequenceEqual(input.Renovations)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Renovations != null)
                    hashCode = hashCode * 59 + this.Renovations.GetHashCode();
