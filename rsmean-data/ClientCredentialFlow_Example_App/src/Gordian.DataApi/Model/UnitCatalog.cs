...
namespace Gordian.DataApi.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UnitCatalog :  IEquatable<UnitCatalog>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="UnitCatalog" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as UnitCatalog);
        }

        /// <summary>
        /// Returns true if UnitCatalog instances are equal
        /// </summary>
        /// <param name="input">Instance of UnitCatalog to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UnitCatalog input)
        {
            if (input == null)
                return false;
