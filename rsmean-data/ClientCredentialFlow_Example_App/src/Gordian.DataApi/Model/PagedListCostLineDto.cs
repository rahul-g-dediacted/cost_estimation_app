...
{
    /// <summary>
    /// PagedListCostLineDto
    /// </summary>
    [DataContract]
    public partial class PagedListCostLineDto :  IEquatable<PagedListCostLineDto>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PagedListCostLineDto" /> class.
        /// </summary>
        /// <param name="offset">The offset..</param>
        /// <param name="limit">The limit..</param>
        /// <param name="recordCount">The record count..</param>
        /// <param name="items">The items..</param>
        public PagedListCostLineDto(int? offset = default(int?), int? limit = default(int?), long? recordCount = default(long?), List<CostLineDto> items = default(List<CostLineDto>))
        {
            this.Offset = offset;
            this.Limit = limit;
        ...
        public List<CostLineDto> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PagedListCostLineDto {\n");
        ...
        {
            return this.Equals(input as PagedListCostLineDto);
        }

        /// <summary>
        /// Returns true if PagedListCostLineDto instances are equal
        /// </summary>
        /// <param name="input">Instance of PagedListCostLineDto to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PagedListCostLineDto input)
        {
            if (input == null)
                return false;
