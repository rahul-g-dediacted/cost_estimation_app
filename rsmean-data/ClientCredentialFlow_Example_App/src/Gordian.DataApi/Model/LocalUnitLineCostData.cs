...
{
    /// <summary>
    /// Localized Unit Line CostData.
    /// </summary>
    [DataContract]
    public partial class LocalUnitLineCostData :  IEquatable<LocalUnitLineCostData>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocalUnitLineCostData" /> class.
        /// </summary>
        /// <param name="exceptionalCost">The exceptional cost..</param>
        /// <param name="exceptionalOpCost">The exceptional op cost..</param>
        /// <param name="installationOpCost">The Installation op cost..</param>
        ...
        public LocalUnitLineCostData(double? exceptionalCost = default(double?), double? exceptionalOpCost = default(double?), double? installationOpCost = default(double?), double? materialCost = default(double?), double? materialOpCost = default(double?), double? laborCost = default(double?), double? laborOpCost = default(double?), double? equipmentCost = default(double?), double? equipmentOpCost = default(double?), double? totalCost = default(double?), double? totalOpCost = default(double?), double? laborCostInHouse = default(double?), double? equipmentCostInHouse = default(double?), double? materialCostInHouse = default(double?), double? totalCostInHouse = default(double?))
        {
            this.ExceptionalCost = exceptionalCost;
            this.ExceptionalOpCost = exceptionalOpCost;
            this.InstallationOpCost = installationOpCost;
        ...
        /// </summary>
        /// <value>The exceptional cost.</value>
        [DataMember(Name="exceptionalCost", EmitDefaultValue=false)]
        public double? ExceptionalCost { get; set; }

        /// <summary>
        /// The exceptional op cost.
        /// </summary>
        /// <value>The exceptional op cost.</value>
        [DataMember(Name="exceptionalOpCost", EmitDefaultValue=false)]
        public double? ExceptionalOpCost { get; set; }

        /// <summary>
        /// The Installation op cost.
        /// </summary>
        /// <value>The Installation op cost.</value>
        [DataMember(Name="installationOpCost", EmitDefaultValue=false)]
        public double? InstallationOpCost { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocalUnitLineCostData {\n");
            sb.Append("  ExceptionalCost: ").Append(ExceptionalCost).Append("\n");
            sb.Append("  ExceptionalOpCost: ").Append(ExceptionalOpCost).Append("\n");
            sb.Append("  InstallationOpCost: ").Append(InstallationOpCost).Append("\n");
        ...
        {
            return this.Equals(input as LocalUnitLineCostData);
        }

        /// <summary>
        /// Returns true if LocalUnitLineCostData instances are equal
        /// </summary>
        /// <param name="input">Instance of LocalUnitLineCostData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocalUnitLineCostData input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.ExceptionalCost == input.ExceptionalCost ||
                    (this.ExceptionalCost != null &&
                    this.ExceptionalCost.Equals(input.ExceptionalCost))
                ) && 
                (
                    this.ExceptionalOpCost == input.ExceptionalOpCost ||
                    (this.ExceptionalOpCost != null &&
                    this.ExceptionalOpCost.Equals(input.ExceptionalOpCost))
                ) && 
                (
                    this.InstallationOpCost == input.InstallationOpCost ||
                    (this.InstallationOpCost != null &&
                    this.InstallationOpCost.Equals(input.InstallationOpCost))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            {
                int hashCode = 41;
                if (this.ExceptionalCost != null)
                    hashCode = hashCode * 59 + this.ExceptionalCost.GetHashCode();
                if (this.ExceptionalOpCost != null)
                    hashCode = hashCode * 59 + this.ExceptionalOpCost.GetHashCode();
                if (this.InstallationOpCost != null)
                    hashCode = hashCode * 59 + this.InstallationOpCost.GetHashCode();
